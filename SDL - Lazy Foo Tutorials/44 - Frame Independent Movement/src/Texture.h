...
bool Texture_createBlank(Texture * texture, Window * window, size_t width, size_t height, SDL_TextureAccess access); // Creates a blank texture of desired dimensions so that we can stream data to it, now let'us define the access type
// Load Functions
...
// Set Functions
void Texture_setAsRenderTarget(Texture * texture, Window * window); // allows us to render the scene to the texture
