...
int main(int argc, char* argv[]){
	...
	while(!quit){
		...
		SDL_RenderSetViewport(renderer, &top_left_viewport); // we provide the area of the screen we want to render to
		
		SDL_RenderCopy(renderer, current_texture, NULL, NULL); // Must always copy the texture for the viewport to render it
